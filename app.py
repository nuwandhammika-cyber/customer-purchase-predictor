...
# --- Suggested Layout Implementation ---

# Main Title
st.markdown("# 🛒 Customer Purchase Prediction System")
st.markdown("### Advanced Machine Learning (COM763)")
st.divider()
...
The prediction is generated using a trained **Random Forest Classifier** achieving **92.45% accuracy**.
""")
st.divider()
...
# Disclaimer Section
st.caption("**Disclaimer:** This tool is for educational purposes and provides predictions based on historical patterns. It does not guarantee actual customer behavior.")

# Sidebar for extra context
with st.sidebar:
    st.title("🏫 University Info")
    st.write("**Wrexham University**")
    st.write("**Module:** Advanced Machine Learning (COM763)")
